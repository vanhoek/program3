...
{
   int s, s1, s2;
   if (score1 <= score2 && score1 < score3) { //changed operator to <=
      s1 = score2;
      s2 = score3;
   } else if (score2 < score1 && score2 < score3) {
      s1 = score1;
      s2 = score3; //modified use score3 instead of score2
   } else if (score3 < score1 && score3 < score2) {
      s1 = score1;
      s2 = score2;
   } else { //all 3 scores are the same
      s1 = score1; //modified from 99 to the value of score1
      s2 = score2; //modified from 99 to the value of score2
   }
   s = s1 + s2;
   return s;
}
...
{
   int s1, s2, s3;
   if (args.length != 3) {  //removed "args==null ||" condition, it cannot be null since it's been initialized
